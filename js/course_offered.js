    ...
    const courseData = {
      bcom: {
        ...
        eligibility: [
          ...
          " c)Organisation of Commerce and Management",
          " d)Geography",
          ...
          "Must have passed the Higher Secondary School Certificate(Std.12) Examination conducted by the different Divisional Boards of the Maharashtra State Board of Secondary and Higher Secondary Education from Arts and Science streams with the following combination of subjects. However,the discretion of allowing a change of stream from Science/Arts rests the Principal. ",
          "1. English",
          "2. Any one of the Modern Indian Language or Modern Foreign Languages or any Classical languages or Information Technology. ",
          "3. Any one subject from the following five subjects:",
          " a)Economics",
          " b)Mathematics",
          " c)Geography",
          " d)Psychology",
          ...
          "1. English",
          "2. Any one Vocational subject carrying 200 marks.",
          "3. Any one subject from the following five subjects:",
          " a)Economics",
          ...
          "1. English",
          "2. Any one of the Modern Indian Language or Modern Foreign Languages or any Classical language or Information Technology.",
          "3. General Foundation Course.",
          "4. Any subject carrying 300 marks from the minimum competency based vocational courses prescribed by the Higher Secondary School Certificate examination from time to time.",
          ...
          semesters: [
            {
              title: "SEMESTER I",
              courses: [
                { course: "1", title: "Data Mining", lectures: "", credit: "", category: "Core Subjects" },
                { course: "2", title: "Distributed System", lectures: "", credit: "", category: "Core Subjects" },
                { course: "3", title: "Data Analysis Tools", lectures: "", credit: "", category: "Core Subjects" },
                { course: "4", title: "Software Testing", lectures: "", credit: "", category: "Core Subjects" }
              ]
            },
            {
              title: "SEMESTER II",
              courses: [
                { course: "1", title: "Mobile Computing", lectures: "", credit: "", category: "Core Subjects" },
                { course: "2", title: "Advanced Computer Networks", lectures: "", credit: "", category: "Core Subjects" },
                { course: "3", title: "Cloud Computing & Ubiquitous Systems", lectures: "", credit: "", category: "Core Subjects" },
                { course: "4", title: "Advanced Database Systems", lectures: "", credit: "", category: "Core Subjects" }
              ]
            }
          ]
        }
        ...
        structure: {
          ...
          semesters: [
            ...
            },
            {
              title: "SEMESTER II",
              courses: [
                { course: "1", title: "Advanced Statistical Methods", lectures: "", credit: "", category: "Core Subjects" },
                { course: "2", title: "Machine Learning", lectures: "", credit: "", category: "Core Subjects" },
                { course: "3", title: "Linear Algebra", lectures: "", credit: "", category: "Core Subjects" },
                { course: "4", title: "Research Methodology", lectures: "", credit: "", category: "Core Subjects" }
              ]
            }
          ]
        }
  ...
  <h2>${course.title}</h2>
  <p style="margin-right: 50px;"><strong>Duration:</strong> ${course.duration}</p>
</div>
...
// --- Auto open course from URL parameter ---
document.addEventListener("DOMContentLoaded", function () {
const urlParams = new URLSearchParams(window.location.search);
const courseId = urlParams.get("course");

if (courseId && courseData[courseId]) {
  // Scroll to the correct course card
