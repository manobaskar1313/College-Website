...
const alumniData = [
  {
    ...
    org: "Spring Marketing Capital",
    image: "img/arun iyer.png",
    description: "Iyer is the Founder and Creative Partner at Spring Marketing Capital. He formerly served as the Chairman and Chief Creative Officer at Lowe Lintas and has also held the role of Senior Copywriter at CNBC-TV18 India."
  },
  {
    name: "Ravikant Rathore",
    role: "Chief Investment Officer",
    org: "Tata Pension Management Limited",
    image: "img/ravikant rathore.png",
    description: "Rathore is the Chief Investment Officer at Tata Pension Management Limited and has previously served as Deputy Vice President (Products) at Tata Asset Management Limited."
  },
  {
    name: "Naresh Iyer",
    role: "Indian Playback Singer",
    org: "Singer",
    image: "img/naresh iyer.png",
    description: "Indian playback singer, has rendered 2000 film songs in several Indian languages and has several chart hits to his credit. His rendition of Roobaroo from the movie Rang De Basanti composed by A. R. Rahman topped the music charts for many weeks in 2006 and won him the National Film Award for Best Male Playback Singer. He won the Filmfare award in the R.D.Burman Musical Talent category."
  },
  {
    name: "Sivaramakrishnan V.",
    role: "Principal",
    org: "Global Infrastructure Partners(GIP)",
    image: "img/sivaramakrishnan.png",
    description: "Sivaramakrishnan is an inverstment professional focused on Infrastructure projects in India. He currently serves as Principal at Global Infrastructure Partners (GIP) after promoting from the position of vice-president. He has also been the Associate Director at IDFC Alternatives Limited."
  },
  {
    name: "Rajeshwari Ramachandran",
    role: "Executive Vice President",
    org: "Human Resources at Pine Labs",
    image: "img/rajeshwari.png",
    description: "Ramachandran is the Executive Vice President of Human Resources at Pine Labs. Previously, she held the position of Senior Manager (Organizational Effectiveness & Capability) at Wipro Technologies. Additionally, she is the Founder of the Human Dog Interaction Project."
  },
  {
    name: "Sachin Sanghvi",
    role: "Music Composer and Singer",
    org: "Hindi and Gujarati films",
    image: "img/sachin.png",
    description: "Sanghvi is a music composer and singer,known as one half of the duo SachinJigar. He is known for his work in Hindi and Gujarati films, and he has composed and arranged for musical stalwarts like A.R. Rahman, Anu Malik, and Pritam before starting his own independent work with Jigar Saraiya."
  },
  {
    name: "Akshay Ridlan",
    role: "Data Engineer",
    org: "leveraging technology and AI to solve realworld problems",
    image: "img/akshay.png",
    description: "Akshay Ridlan is a 25-year-old Data Engineer with a deep passion for leveraging technology and AI to solve realworld problems, As a visionary social entrepreneur, he has pioneered multiple initiatives aimed at social good, particularly in animal welfare, missing persons' reunification, and healthcare for cattle. he is mentoring students, aspiring data scientists, and tech enthusiasts, shaping the future of AI-driven solutions in India. For his remarkable contributions to society through technology, Akshay Ridlan has been honored with prestigious awards: - Amazing Indian Award 2024 by Times Group (Category: Social Innovation using Technology) - Tech for Good Award 2024 by Salesforce and Mint These accolades recognize his unwavering commitment to leveraging AI for humanitarian causes and building impactful tech solutions. Akshay is deeply committed to developing AI and technology solutions for Bharat with Sevaa Bhaav a spirit of selfless service. His vision is to create inclusive, impactful, and scalable AI-driven initiatives that uplift communities, protect animals, and enhance social welfare."   }
];

// Generate Alumni Carousel Slides
const alumniContainer = document.getElementById("alumniContainer");
let items = "";
for (let i = 0; i < alumniData.length; i += 4) {
  const group = alumniData.slice(i, i + 4);
  const activeClass = i === 0 ? "active" : "";
  items += `
    <div class="carousel-item ${activeClass}">
      <div class="row justify-content-center">
        ${group.map((a, index) => `
          <div class="col-md-3 alumni-page-item" data-index="${i + index}">
            <img src="${a.image}" alt="${a.name}" class="alumni-page-img">
            <div class="alumni-page-name">${a.name}</div>
            <div class="alumni-page-role">${a.role}</div>
            <div class="alumni-page-org">${a.org}</div>
          </div>
        `).join("")}
      </div>
    </div>`;
}
alumniContainer.innerHTML = items;

// Modal Logic
const alumniModal = new bootstrap.Modal(document.getElementById("alumniModal-page"));
document.querySelectorAll(".alumni-page-item").forEach(item => {
  item.addEventListener("click", () => {
    ...
    document.getElementById("modalOrg").textContent = a.org;
